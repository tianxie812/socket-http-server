...
def response_path(path):
    ...
    if os.path.isdir(local_path):
        if 'images' in local_path:
            content = b"JPEG_example.jpg, sample_1.png, Sample_Scene_Balls.jpg"
        else:
            content = b"images/, a_web_page.html, make_time.py, sample.txt,favicon.ico," \
                      b".DS_Store"
        ...
        elif 'jpg' in local_path:
            mime_type = b"image/jpeg"
        elif 'txt' in local_path:
            mime_type = b"text/plain"
        elif 'html' in local_path:
